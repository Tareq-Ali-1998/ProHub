...
/*
 * This following query retrieves the jobs information for the completed and non-completed jobs, and if the
 * job is completed (have been done by some freelancer), then it will retrieves the freelancer_id, the
 * frist_name, the last_name, and the profile_picture_path of the freelancer, and if the job hasn't been
 * completed yet by any freelancer (it's an available job), then all those values will be null.
 * 
 ...
 * 
 * The result records of the query are ordered based on the job_creation_date columns in the jobs table, with the
 * most recent jobs appearing first.
 * 
